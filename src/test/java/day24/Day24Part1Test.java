 ...
 * 
 * Gates wait until both inputs are received before producing output; wires can carry 0, 1 or no value at all. There are 
 *   no loops; once a gate has determined its output, the output will not change until the whole system is reset. Each 
 ...
 *   section specifies these values. For example, x00: 1 means that the wire named x00 starts with the value 1 (as if 
 ...
 *   an instance of an AND gate which has wires x00 and y00 connected to its inputs and which will write its output 
 *   to wire z00.
 * 
 * In this example, simulating these gates eventually causes 0 to appear on wire z00, 0 to appear on wire z01, and 1 
 *   to appear on wire z02.
 * 
 ...
 * 
 * Your puzzle answer was 57344080719736.
 */
